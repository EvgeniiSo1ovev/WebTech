...
/****функция преобразования температуры по нажитию кнопки*****/
function onclick_button(){
    const temperature_C = document.getElementById("temperature_C").value;
    const temperature_F = (9 / 5) * temperature_C + 32;
    alert(`Температура в градусах Цельсия: ${temperature_C}\nТемпература в градусах по Фаренгейту: ${temperature_F.toFixed(1)}`);
};
/*********/